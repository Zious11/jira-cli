...
# BC Master Index — fixture (bc-drift-canonical-d)

DRIFT INJECTED: Surface D — the CANONICAL-COUNTS.md per-file total_bcs table row for
bc-2-issue-read.md claims 15, but bc-2 frontmatter total_bcs: 20 (Surface A), the
## Section 2 header (Surface B), and the frontmatter sections: line (Surface C) all say 20.
Only Surface D is drifted.
Expected guard behavior: exits 1 with ERROR about bc-2-issue-read.md total_bcs frontmatter
vs CANONICAL-COUNTS.md table row mismatch.
