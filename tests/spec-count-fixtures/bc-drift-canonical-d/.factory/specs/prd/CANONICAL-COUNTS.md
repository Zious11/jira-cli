...
product: jr-fixture (bc-drift-canonical-d)
generated: "2026-01-01"
last_verified: "2026-01-01 (fixture for spec-count-fixtures test suite)"
---

# Canonical Counts — fixture (bc-drift-canonical-d)

This fixture drifts ONLY Surface D: the per-file total_bcs table row for bc-2-issue-read.md
says 15 while all other surfaces (A: frontmatter, B: Section header, C: sections: line)
agree on 20.
