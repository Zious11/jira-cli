...
sections:
  ...
  - bc-2-issue-read.md (15 BCs cumulative; 15 individually-bodied)
---

# BC Master Index — fixture (bc-drift-sections-c)

DRIFT INJECTED: Surface C — the frontmatter sections: line for bc-2-issue-read.md claims
"15 BCs cumulative" but bc-2 frontmatter total_bcs: 20 (Surface A) and the ## Section 2
header (Surface B) both say 20. Only Surface C is drifted.
Expected guard behavior: exits 1 with ERROR about bc-2-issue-read.md total_bcs frontmatter
vs BC-INDEX.md sections: line mismatch.
