...
# BC Master Index — fixture (bc-drift-total)

DRIFT INJECTED: Section 2 header claims "15 BCs cumulative" but bc-2 frontmatter says total_bcs: 20.
Expected guard behavior: exits 1 with ERROR about bc-2-issue-read.md total_bcs frontmatter vs BC-INDEX Section 2 header mismatch.
...
## Section 2: Issue Read (bc-2-issue-read.md) — 15 BCs cumulative; 15 individually-bodied
...
### 2.2 Issue List (4 BCs: BC-2.2.009..012)

| L3 BC ID | Summary |
|---|---|
| BC-2.2.009 | Example list contract one |

### 2.3 Issue View (3 BCs: BC-2.3.013..015)

| L3 BC ID | Summary |
|---|---|
| BC-2.3.013 | Example view contract one |
