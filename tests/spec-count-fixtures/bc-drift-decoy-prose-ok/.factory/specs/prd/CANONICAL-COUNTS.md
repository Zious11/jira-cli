...
product: jr-fixture (bc-drift-decoy-prose-ok)
generated: "2026-01-01"
last_verified: "2026-01-01 (fixture for spec-count-fixtures test suite)"
---

# Canonical Counts — fixture (bc-drift-decoy-prose-ok)

This fixture tests that the guard ignores `behavioral contracts` lines in the body
(below a `## ` heading) and reads only the preamble prose. All count surfaces agree
on the correct value (30); the decoy line in bc-2-issue-read.md body says "999
behavioral contracts" but is structurally invisible to the guard's
`sed '/^## /q'` truncation.
