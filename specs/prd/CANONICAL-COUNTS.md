...
last_verified: "2026-05-20 (F2 delta issue #385; +2 BC-3.8.016..017; bc-3 definitional 64→66 total_bcs 93→95)"
---
...
**Canonical grand total: 575** (+4 BC-7.4.013-016 added 2026-05-08 via Fix-PR A `28b0f35`; +1 BC-2.6.050 added 2026-05-13 via issue #350; +1 BC-2.6.051 added 2026-05-14 via issue #365; +1 BC-3.4.009 added 2026-05-15 via issue #340 F2; +18 BC-3.8.001..010 + BC-X.12.001..008 added 2026-05-18 via issue #288 F2+F1d; +3 BC-3.8.011..013 added 2026-05-19 via issue #288 F1d + issue #383 F2; +4 BC-3.8.014..015 + BC-X.8.006..007 added 2026-05-19 via issue #384 F2; +2 BC-3.8.016..017 added 2026-05-20 via issue #385 F2)

_Note: BC-INDEX.md `total_bcs` header updated to 575 to match this file. CANONICAL-COUNTS.md carries the per-file sum as the primary source of truth. (+2 since last verified: BC-3.8.016..017 added at F2 issue #385 2026-05-20)_

Breakdown:
- 575 = sum of per-file `total_bcs` values (canonical; see per-file table above)
- 343 of 575 are individually-bodied (have a `#### BC-` heading)
...
| bc-03-issue-write.md | 77 | bc-3-issue-write.md | 95 | PENDING (L2 bc_count not yet bumped; L3 +1 BC-3.4.009 2026-05-15; +10 BC-3.8.001-010 2026-05-18; +3 BC-3.8.011-013 2026-05-19; +2 BC-3.8.014-015 2026-05-19; +2 BC-3.8.016-017 2026-05-20) |
